        ...
        <div className='max-w-md w-full'>
          <Link
            ...
            <img
              src={Logo}
              alt='brand'
              className='h-10 w-10 lg:hidden m-0 hover:scale-105 duration-500 delay-100 transition-all'
            />
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {/* Currency Select */}
            {/* <div className='mb-4'>
              <label className='block text-sm font-medium text-text-light mb-1' htmlFor='currency'>
                Currency
              </label>
              <CurrencySelect register={register} errors={errors} />
              {errors.currency && <FormError err={errors.currency.message} />}
            </div> */}
